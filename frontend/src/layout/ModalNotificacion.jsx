export default function ModalNotificacion({ visible, onConfirm, onCancel }) {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-45 z-50">
      <div className="bg-gray-700 p-6 rounded-lg shadow-lg w-96">
        <h2 className="text-2xl font-semibold mb-4">Confirmar Entrega</h2>
        <p className="text-white mb-6">
          ¿Deseas confirmar que la tarea fue entregada?
        </p>
