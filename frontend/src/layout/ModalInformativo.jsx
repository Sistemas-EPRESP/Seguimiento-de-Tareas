...
export default function ModalInformativo({ modalInfo, onClose }) {
  ...
  return (
    <div
      ...
      onClick={onClose} // El clic fuera del modal cierra el modal
    >
      <div className="absolute inset-0 bg-black opacity-50"></div>
      <div
        className="flex flex-col items-center rounded-lg border border-gray-600 shadow-sm p-6 z-10 w-full max-w-md bg-gray-800"
        onClick={handleModalClick} // Evita que el clic dentro del modal cierre el fondo
      >
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="whitespace-nowrap leading-none tracking-tight text-center text-gray-100 text-2xl font-semibold">
            {modalInfo.titulo}
